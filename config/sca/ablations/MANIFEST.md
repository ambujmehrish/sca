...
| A4_eta_0.9 | `./config/sca/ablations/A4_eta_0.9.json` | EMA eta 0.99 -> 0.9 | E7 |
| A4_eps_floor_0 | `./config/sca/ablations/A4_eps_floor_0.json` | eps-floor OFF (collapse check) | E7 |
| A5_mask_freq | `./config/sca/ablations/A5_mask_freq.json` | freq-weighted m-dagger (S dropped most, then A) | E4 |
...
| A8_lambda_0 | `./config/sca/ablations/A8_lambda_0.json` | L_unif OFF | E8 |
| A8_lambda_0.05 | `./config/sca/ablations/A8_lambda_0.05.json` | lambda = 0.05 | E8 |
| A8_lambda_0.3 | `./config/sca/ablations/A8_lambda_0.3.json` | lambda = 0.3 | E8 |
| A8_unif_weighted | `./config/sca/ablations/A8_unif_weighted.json` | (1 - S*)-weighted repulsion | E8 |
| A9_sstar_minilm | `./config/sca/ablations/A9_sstar_minilm.json` | S* from all-MiniLM-L6-v2 | E6 |
| A9_taustar_0.3 | `./config/sca/ablations/A9_taustar_0.3.json` | tau* = 0.3 (sharper) | E6 |
| A9_taustar_1.0 | `./config/sca/ablations/A9_taustar_1.0.json` | tau* = 1.0 (no sharpening) | E6 |
| A9_topk_32 | `./config/sca/ablations/A9_topk_32.json` | top-32 sparsification | E6 |
| A9_topk_128 | `./config/sca/ablations/A9_topk_128.json` | top-128 sparsification | E6 |
